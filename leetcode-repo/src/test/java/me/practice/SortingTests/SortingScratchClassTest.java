...
public class SortingScratchClassTest {
    ...
    public void testHeapSortPracWithSize10Input() {
        assertArrayEquals(expectedArrSize10, SortingScratchClass.heapSortPractice2(randArraySize10));
    }
    ...
    public void testCountSortPrac() {
        assertArrayEquals(expectedCountArrayRandomVariaton,
                SortingScratchClass.countSortPrac(randCountArrayRandomVariation));
    }

    @Test
    public void testCountSortPracWithNoZeroVariation() {
        assertArrayEquals(expectedCountArrayNoZeroVariation,
                SortingScratchClass.countSortPrac(randCountArrayNoZeroVariation));
    }

    @Test
    public void testCountSortPractice() {
        assertArrayEquals(expectedCountArrayRandomVariaton,
                SortingScratchClass.countSortPractice(randCountArrayRandomVariation));
    }
